...
# 5. Add title and labels
plt.title("Line Graph Of Height Variation of First 10 Hills")
...
plt.title("1.Line Graph Of Height Trend of All Hills")
plt.xlabel("Index")
plt.ylabel("Height")
plt.grid(True)
...
plt.title("Stacked Bar Chart Of Height Category per Region")
plt.xlabel("Region")
plt.ylabel("Count")
