...
# 6. Save the graph
plt.savefig("Graphs/Line Graph Of house_prices_line.png")
...
# 7. Save graph
plt.savefig("Graphs/Bar Graph Of expensive_houses_bar.png")
...
print("\n(S4)counting number of houses bedrooms\n", bedroom_counts)
print("========================================================")

# 2. Select top 5 bedroom categories
top5 = bedroom_counts.head()
print("\n(S4)Selecting Top 5 bedroom categories\n", top5)
print("========================================================")
print("========================================================")
...
# 6. Save graph
plt.savefig("Graphs/Pie Chart Of bedroom_distribution.png")
...
plt.title("1.Line graph Of Price trends for all houses")
plt.xlabel("Index")
plt.ylabel("Price")
plt.grid(True)
plt.tight_layout()
plt.savefig("Graphs/1.Line graph Of price_trend.png")
plt.show()
...
plt.title("Stacked Bar chart Of Price Category per Bedroom")
plt.xlabel("Bedrooms")
plt.ylabel("Count of price categories")
plt.xticks(rotation=45)
plt.legend(title="Price Category")
plt.tight_layout()
plt.savefig("Graphs/Stacked Bar chart Of price_category_stacked.png")
plt.show()
...
plt.tight_layout()
plt.savefig("Graphs/Histogram Of price_histogram.png")
plt.show()
