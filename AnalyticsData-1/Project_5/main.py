...
print(f"(S1)Displaying First 5 rows:\n{df.head()}")
print("========================================================")

print(f"(S1)Displaying last 5 rows:\n{df.tail()}") #Last 5 rows
print("========================================================")

print(f"(S1)Column names:\n{df.columns}") #Column names
print("========================================================")

print(f"(S1)Shapes of Dataset:{df.shape}\n") #Shape of dataset
print("========================================================")
...
print(f"(S1)Minimun Selling Price: {min_S_price}")
print("========================================================")

# maximum selling price 
max_S_price=S_price.max()
print(f"(S1)Maximum Selling Price: {max_S_price}")
print("========================================================")

# average selling price
avg_S_price=S_price.mean()
print(f"(S1)Average Selling Price: {avg_S_price:.2f}")
print("========================================================")
print("========================================================")
...
# Save and show
plt.savefig("Graphs/(S2)Line graph Of selling_price_trend.png")
plt.show()
...
# 7. Save graph
plt.savefig("Graphs/(S3)Bar Graph Of expensive_cars_fueltype_bar.png")
...
# 7. Save graph
plt.savefig("Graphs/(S4)Pie Chart Of fuel_type_distribution.png")
...
# Save graph
plt.savefig("Graphs/(S5)Scatter Graph Of present_vs_selling_price.png")
...
plt.title("Bar Chart Of Number of cars per each category")  #title
plt.xlabel("Car Age Category")   # X-label
plt.ylabel("Count")              # Y-label
plt.savefig("Graphs/(S6)Bar Chart Of Car_count.png") # To save the graph
plt.show()
...
# 5. Save graph
plt.savefig("Graphs/(S7)Histogram Of Kms_Driven.png")

# 6. Show plot
plt.show()

# 7. Observation (print statement)
print("(S7)Observation: Most cars tend to have lower mileage if bars are higher on the left side of the histogram.")
print("========================================================")
print("========================================================")
...
plt.title("Bar Chart Of Average Selling Price by Transmission")
plt.xlabel("Transmission")
plt.ylabel("Average Selling Price")

# Save graph
plt.savefig("Graphs/(S8)Bar Chart Of Transmission_vs_SellingPrice.png")
plt.show()
...
# Print values
print("(S9)Seller Types:", labels)
print("(S9)Counts:", values_array)
print("========================================================")
...
plt.title("Bar Chart Of Seller Type Analysis")

# Save graph
plt.savefig("Graphs/(S9)Bar Chart Of seller_type_analysis.png")
...
print(f"(S9)The most common seller type is: {most_common}")
print("========================================================")
print("========================================================")
...
print("(S10)Dataset with Price Difference Column:\n")
print(df.head())
print("========================================================")
...
print("\n(S10)Price Changes Between Consecutive Rows:\n")
print(price_changes)
print("========================================================")
...
print("\n(S10)Average Depreciation:", average_depreciation)
print("(S10)Maximum Depreciation:", maximum_depreciation)
print("(S10)Minimum Depreciation:", minimum_depreciation)
print("========================================================")
...
plt.title("Line Graph Of Selling Price Trend")
plt.xlabel("Car Index")
plt.ylabel("Selling Price")
plt.savefig("Graphs/(S10.1)Line Graph Of selling_price_trend.png")
plt.show()
...
plt.title("Bar Chart Of Average Selling Price by Fuel Type")
plt.xlabel("Fuel Type")
plt.ylabel("Average Selling Price")
plt.savefig("Graphs/(S10.2)Bar Chart Of fuel_type_avg_price.png")
plt.show()

# 3. Histogram - Selling Price Distribution
plt.figure(figsize=(8,5))
plt.hist(df["Selling_Price"], bins=10)
plt.title("Histogram Of Distribution of Selling Prices")
plt.xlabel("Selling Price")
plt.ylabel("Frequency")
plt.savefig("Graphs/(S10.3)Histogram Of selling_price_distribution.png")
plt.show()
...
print(f"\n(S10)Fuel type with highest average selling price: {highest_fuel}")

print(f"\n(S10)Transmission type with higher average selling price: {higher_transmission}")

# Price concentration insight
median_price = df["Selling_Price"].median()

if median_price < df["Selling_Price"].mean():
    print("\n(S10)Most cars are concentrated in lower selling prices.")
else:
    print("\n(S10)Most cars are concentrated in higher selling prices.")
...
print("\n(S10)Correlation between Car Age and Selling Price:", correlation)

if correlation < 0:
    print("(S10)Older cars tend to have lower selling prices.")
else:
    print("(S10)Older cars do not necessarily have lower selling prices.")
